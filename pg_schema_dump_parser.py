...
def generate_metadata(directory: str, host: str, dbname: str, port: str, user: str, password: str, elapsed_time: str, warnings: bool) -> str:
    """ Generates metadata """
...
if __name__ == "__main__":
    ...
    with pg_schema_dump(postgres_host, postgres_db, postgres_port, postgres_user, postgres_password) as f:
        ...
        for segment in read_in_chunk(f, separator=';\n'):
            ...
            elif segment.startswith(("CREATE AGGREGATE", "CREATE OR REPLACE AGGREGATE")):
                parse_object(segment, 'aggregates', True)
            elif segment.startswith(("CREATE FUNCTION", "CREATE OR REPLACE FUNCTION", "CREATE PROCEDURE", "CREATE OR REPLACE PROCEDURE")):
